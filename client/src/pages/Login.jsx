...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
      {/* Image Section */}
      <div className="w-full md:w-1/2 lg:w-2/5 bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center p-12">
        <div className="text-white text-center">
          <img 
            src="https://t3.ftcdn.net/jpg/02/23/47/36/360_F_223473605_QZguR4hczOIkKmoX3YJ9uRYsrmzN5XaM.jpg" 
