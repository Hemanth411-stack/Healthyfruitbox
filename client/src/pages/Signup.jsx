...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
      {/* Image Section */}
      <div className="w-full md:w-1/2 lg:w-2/5 bg-gradient-to-br from-violet-800 to-violet-300 flex items-center justify-center p-12">
        <div className="text-white text-center">
          <img 
            src="https://img.freepik.com/premium-vector/different-types-fruits-vector-illustration-concept_1253202-28155.jpg" 
            alt="Signup Illustration" 
            className="w-full max-w-md mx-auto rounded-lg shadow-xl mb-8"
          />
